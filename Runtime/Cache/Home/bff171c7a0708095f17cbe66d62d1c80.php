    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <p class="text-right">Welcome to wwt! 
                ...
                <h4 class="header-line">Source info Page </h4>
                 ...
                 <div class="table-responsive">
                   ...
                   <?php if($count > 0): ?><table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <tr class="odd gradeX ">
                             ...
                             <th class="text-center">开始运输日期</th> 
                    ...
                    <?php if(is_array($data1)): foreach($data1 as $key=>$v): ?><tr class="even gradeC">
                             ...
                             <td class="center">
                                  <a  href="<?php echo U('Home/Source/s_modify',array('sid'=>$v['sid']));?>"  class="btn btn-success btn-xs">更新</a>
                                  <a  href="<?php echo U('Home/Source/s_delete',array('sid'=>$v['sid']));?>"  class="btn btn-danger btn-xs" >删除</a>
                             </td>
                        </tr><?php endforeach; endif; ?> 
                    </table>
                    <?php else: ?><h3>还没有货源信息,去发布吧</h3>
                           <p>
                              <a href="<?php echo U('Home/Source/s_add');?>">add one</a>
                           </p><?php endif; ?>
                  </div>
               </div>
             </div>
