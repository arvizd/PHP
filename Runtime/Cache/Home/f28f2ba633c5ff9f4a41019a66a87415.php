    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <p class="text-right">Welcome to wwt! 
                ...
                <h4 class="header-line">Source add Page</h4>
            </div>
        </div>
             <div class="row">
             <div class="col-md-12">
               <div class="alert alert-info text-center">
                <!-- <font size="3">  Hello,<?php echo ($data['name']); ?>！</font><br/> -->
                 <div class="table-responsive">
                   <h3>发布货源信息</h3>
                    <form action="<?php echo U('Home/Source/ds_add');?>" method="post">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <tr class="odd gradeX">
                             <td class="text-right">出发地</td>
                             <td class="text-center"><input type="text"  name="s_start" required></td>         
                        </tr>
                        <tr class="even gradeC">
                             <td class="text-right">目的地</td>
                             <td class="text-center"><input type="text" name="s_end" required/></td>
                        </tr> 
                        <tr class="odd gradeX">
                             <td class="text-right">距离</td>
                             <td class="text-center">
                                  <input type="text"  name="s_distance" required/>
                             </td>
                        </tr>   
                        <tr class="even gradeC">
                             <td class="text-right">重量</td>
                             <td class="text-center"><input type="text"  name="weight" required></td>
                        </tr>
                        <tr class="odd gradeX">
                             <td class="text-right">金额</td>
                             <td class="text-center"><input type="text" name="amount" required></td>
                        </tr>
                        <tr class="even gradeC">
                             <td class="text-right">详细描述</td>
                             <td class="text-center"><input type="text" name="des"></td>
                        </tr> 
                        <tr class="odd gradeX">
                        ...
                        <tr class="even gradeC">
                             <td class="text-center" colspan="2">
                                <input type="submit" value="add" class="btn btn-success" id="sa"/>
