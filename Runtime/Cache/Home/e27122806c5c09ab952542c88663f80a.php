                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li>
                                <a href="<?php echo U('Home/Driver/d_modify');?>" class="menu-top-active">Driver</a>
                            </li>
                            <li>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <p class="text-right">Welcome to wwt! 
                ...
                <h4 class="header-line">Modify Page</h4>
               ...
               <div class="alert alert-info text-center">
                <!-- <font size="3">  Hello,<?php echo ($data['name']); ?>！</font><br/> -->
                 <div class="table-responsive">
                   <h3>个人信息更新</h3>
                    <form action="<?php echo U('Home/Driver/d_update');?>" method="post">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <tr class="odd gradeX">
                             <td class="text-right">姓名</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['name']); ?>" name="name"></td>            
                        </tr>
                        <tr class="even gradeC">
                             <td class="text-right">身份证号</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['id']); ?>" name="ID" readonly></td>
                        </tr> 
                        <tr class="odd gradeX">
                             <td class="text-right">手机号码</td>
                             <td class="text-center">
                                  <input type="text" value="<?php echo ($data['tel']); ?>" name="tel" id="tel" readonly>
                             </td>
                        </tr>   
                        <tr class="even gradeC">
                             <td class="text-right">电子邮箱</td>
                             <td class="text-center"><input type="email" value="<?php echo ($data['email']); ?>" name="email"></td>
                        </tr>
                        <tr class="odd gradeX">
                             <td class="text-right">所在地</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['place']); ?>" name="place"></td>
                        </tr>
                        <tr class="even gradeC">
                             <td class="text-right">驾龄</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['d_age']); ?>" name="d_age"></td>
                        </tr>
                        <tr class="odd gradeX">
                             <td class="text-right">驾驶证类型</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['d_type']); ?>" name="d_type"></td>
                        </tr> 
                        <tr class="even gradeC">
                            <td class="text-right">状态</td>
                            <td class="text-center"><input type="text" value="<?php echo ($data['status']); ?>" name="status">
                            </td>
                        </tr> 
                        <tr class="even gradeC">
