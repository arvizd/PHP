    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <p class="text-right">Welcome to wwt! 
                ...
                <h4 class="header-line">Driver Manage Page</h4>
            </div>
        </div>
             <div class="row">
             <div class="col-md-12">
                 ...
                 <div class="table-responsive">
                   ...
                   <?php if($count > 0): ?><table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="even gradeC">
                             ...
                             <td class="center"><?php echo ($v["d_age"]); ?></td>
                             <td class="center"><?php echo ($v["d_type"]); ?></td>
                             <td class="center"><?php echo ($v["status"]); ?></td>
                             <td class="center">
                                  <a  href="<?php echo U('Home/Driver/dm_delete',array('did'=>$v['did']));?>"  class="btn btn-danger btn-xs" >删除</a>
                             </td>
                        </tr><?php endforeach; endif; ?> 
                    </table>
                    <?php else: ?><h4>还没有司机信息</h4><?php endif; ?>
                  </div>
