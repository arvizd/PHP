                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li class="menu-top-active">
                                <a href="<?php echo U('Home/Owner/o_manage');?>">Owner</a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            ...
            <p class="text-right">Welcome to wwt! 
                ...
                <h4 class="header-line">Owner Manage Page</h4>
            </div>
        </div>
             <div class="row">
             <div class="col-md-12">
                 ...
                 <div class="table-responsive">
                   ...
                   <?php if($count > 0): ?><table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="even gradeC">
                             ...
                             <td class="center"><?php echo ($v["place"]); ?></td>
                             <td class="center"><?php echo ($v["comp"]); ?></td>
                             <td class="center">
                                  <a  href="<?php echo U('Home/Owner/om_delete',array('oid'=>$v['oid']));?>"  class="btn btn-danger btn-xs" >删除</a>
                             </td>
                        </tr><?php endforeach; endif; ?> 
                    </table>
                    <?php else: ?><h4>还没有货主信息</h4><?php endif; ?>
                  </div>
