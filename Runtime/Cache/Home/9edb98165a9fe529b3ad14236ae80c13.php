                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li>
                                <a href="<?php echo U('Home/Owner/o_modify');?>" class="menu-top-active">Owner</a>
                            </li>
                            <li>
             ...
             <div class="col-md-12">
               <div class="alert alert-info text-center">
                 <div class="table-responsive">
                   <h3>个人信息更新</h3>
                    <form action="<?php echo U('Home/Owner/o_update');?>" method="post">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr class="even gradeC">
                             <td class="text-right">所在公司名</td>
                             <td class="text-center"><input type="text" value="<?php echo ($data['comp']); ?>" name="comp"></td>
                        </tr>
                        <tr class="even gradeC">
