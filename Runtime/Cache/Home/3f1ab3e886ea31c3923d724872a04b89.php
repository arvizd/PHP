...
<link rel="stylesheet" href="<?php echo hcss_url;?>show.css" />
</head>
<body>
<!--头部-->
...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			<div class='location'>
				<a href="">首页</a>>
				<?php $count=count($parent)-1; ?>
				<?php if(is_array($parent)): foreach($parent as $key=>$v): ?><a href="<?php echo U('/c_'.$v['id']);?>"><?php echo ($v["name"]); ?></a><?php if($key != $count): ?>><?php endif; endforeach; endif; ?>
			</div>
			<div class="title">
				<p><?php echo ($blog["title"]); ?></p>
				<div>
					<span class='fl'>发布于：<?php echo (date('Y年m月d日',$blog["time"])); ?></span>
					<span class='fr'>已被阅读<script type="text/javascript" src="<?php echo U('Home/Show/clickNum',array('id'=>$blog['id']));?>"></script>次</span>
				</div>
			</div>
			<div class='content'>
