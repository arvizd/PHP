                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="<?php echo U('Home/Driver/d_modify');?>">Driver</a></li>
                             <li>
                ...
                <!-- <font size="3">  Hello,<?php echo ($data['name']); ?>！</font><br/> -->
                 <div class="table-responsive">
                   <h3>个人信息</h3>
                    ...
                    <?php if($data['name']!='' ): ?><tr class="odd gradeX">
                    ...
                    <?php if($data['email']!='' ): ?><tr class="even gradeC">
                             <td class="text-right">电子邮箱</td>
                             <td class="center"><?php echo ($data['email']); ?></td>            
                        </tr><?php endif; ?>
                    <?php if($data['place']!='' ): ?><tr class="odd gradeX">
                             <td class="text-right">所在地</td>
                             <td class="center"><?php echo ($data['place']); ?></td>            
                        </tr><?php endif; ?>
                    <?php if($data['d_age']!='' ): ?><tr class="even gradeC">
                             <td class="text-right">驾龄</td>
                             <td class="center"><?php echo ($data['d_age']); ?></td>            
                        </tr><?php endif; ?>
                    <?php if($data['d_type']!='' ): ?><tr class="odd gradeX">
                             <td class="text-right">驾驶证类型</td>
                             <td class="center"><?php echo ($data['d_type']); ?></td>            
                        </tr><?php endif; ?>  
                    <tr class="even gradeC">
