...
<link rel="stylesheet" href="<?php echo hcss_url;?>index.css" />
</head>
<body>
<!--头部-->
...
<div class='top-nav-wrap'>
		<ul class='nav-lv1'>
			<li class='nav-lv1-li'>
				<a href="<?php echo U('Home/index');?>" class='top-cate'>博客首页</a>
			</li>
					<?php
		...
		<div class='main-left'>
		 ...
		 <?php if(is_array($Cate)): foreach($Cate as $key=>$v): ?><dl>
				...
				<dt><?php echo ($v["name"]); ?><a href="<?php echo U('/c_'.$v['id']);?>">更多>></a></dt>
				 <?php if(is_array($v["blog"])): foreach($v["blog"] as $key=>$a): ?><dd>
					<a href="<?php echo U('/'.$a['id']);?>" target='_blank'><?php echo ($a["title"]); ?></a>
					<span><?php echo (date('m/d',$a["time"])); ?></span>
